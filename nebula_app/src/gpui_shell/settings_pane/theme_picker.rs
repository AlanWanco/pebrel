        ...
        v_flex()
            ...
            .child(
                h_flex()
                    ...
                    .child(div().text_size(ui(9.0)).text_color(ink.opacity(0.6)).child(language.text(Message::ThemeTransferPreview))),
            )
            .child(
                v_flex()
                    .id(if typography {
                    ...
                    .child(div().mt(ui(if compact { 6.0 } else { 10.0 })).text_size(px(size * 0.75)).child(format!(
                        "{} · {}",
                        crate::brand::NAME,
                        std::env::consts::OS
                    )))
                    ...
                    .child(
                        h_flex()
                            .mt(ui(if compact { 8.0 } else { 17.0 }))
                            .gap(ui(7.0))
                            .child(div().text_color(accent).child("❯"))
    ...
    pub(super) fn theme_picker_body(
        ...
        let grid = h_flex()
            ...
            .children(picker.choices().into_iter().map(|choice| {
                ...
                let content =
                    v_flex().w_full().p(ui(if compact { 6.0 } else { 8.0 })).child(sample).child(
                        h_flex()
                            .mt(ui(8.0))
                            .justify_between()
                            .gap(ui(3.0))
        ...
        let preview = v_flex()
            .w(px(if compact { width } else { 230.0 * scale }))
            .flex_shrink_0()
            .child(preview)
            .child(
                div()
                    .mt(ui(if compact_preview { 11.0 } else { 19.0 }))
                    .text_size(ui(13.0))
                    .font_semibold()
            ...
            .child(
                h_flex()
                    .mt(ui(if compact_preview { 9.0 } else { 20.0 }))
                    .pt(ui(if compact_preview { 9.0 } else { 17.0 }))
                    .justify_center()
                    .gap(ui(9.0))
                    .border_t_1()
        ...
        if compact {
            v_flex().w(px(width)).gap(ui(20.0)).child(preview).child(grid_column)
        } else {
            h_flex().w(px(width)).items_start().gap(ui(25.0)).child(grid_column).child(preview)
        }
    }
}
