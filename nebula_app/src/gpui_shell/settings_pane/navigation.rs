...
pub(super) const SECTION_SEARCH_TERMS: [&str; 10] = [
    ...
    "appearance 外观 ui scale zoom 缩放 整体 大小 1080p theme 主题 custom 自定义 template 模板 import 导入 export 导出 font 字体 opacity 透明度 background 背景 cursor 光标 icon 图标 dim inactive panes 调暗非活动窗格 分屏变暗 scrollback scrolling speed history 回滚 滚动 速度 历史",
