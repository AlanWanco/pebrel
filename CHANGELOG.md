...
- 改进：`Pebrel-v1.8.0-windows-x64.zip`: `PENDING FINAL BUILD`
- 改进：`Pebrel-v1.8.0-windows-x64-setup.exe`: `PENDING FINAL BUILD`
- 改进：`Pebrel-v1.8.0-linux-x64-preview.AppImage`: `PENDING FINAL BUILD`
- 改进：`Pebrel-v1.8.0-linux-x64-preview.deb`: `PENDING FINAL BUILD`
- 改进：`Pebrel-v1.8.0-linux-x64-preview.tar.gz`: `PENDING FINAL BUILD`
- 改进：`Pebrel-v1.8.0-macos-arm64-preview.dmg`: `PENDING FINAL BUILD`
- 改进：`Pebrel-v1.8.0-macos-x64-preview.dmg`: `PENDING FINAL BUILD`
