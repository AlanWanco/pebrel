...
- Restored the bundled monospace font for sidebar labels, top tabs, and pane titles while retaining the independent interface text-size setting.
...
- 侧栏标签、顶部标签和窗格标题恢复使用内置等宽字体，同时保留独立的界面字号设置。
